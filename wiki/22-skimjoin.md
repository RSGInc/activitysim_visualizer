...
8. Regenerate wiki catalogs if summary specs or dashboard requirements changed.
...
| Symptom | Check |
|---|---|
| No skim columns appear | `skimjoin.enabled`, config path, run overrides, and skim file glob resolution. |
