...
def component_display_name(
    ...
    *,
    ...
    special_labels = {
        ...
        "skim_transit_o_maz_stop_walk_bus": "Origin Walk to Local Bus Stop",
        "skim_transit_d_maz_stop_walk_bus": "Destination Walk from Local Bus Stop",
        "skim_transit_o_maz_stop_walk_premium": "Origin Walk to Premium Transit Stop",
        "skim_transit_d_maz_stop_walk_premium": "Destination Walk from Premium Transit Stop",
