...
def component_display_name(
    ...
    *,
    ...
    special_labels = {
        ...
        "skim_transit_tiv": "Transit In-Vehicle Time (min)",
        "skim_transit_auxiliary_walk_time": "Transit Auxiliary Walk Time (min)",
        "skim_transit_first_wait_time": "Transit First Wait Time (min)",
        "skim_transit_transfer_wait_time": "Transit Transfer Wait Time (min)",
        "skim_transit_num_transfers": "Transit Number of Transfers",
        "skim_transit_fare": "Transit Fare ($)",
        "skim_transit_brt_ivtt": "BRT In-Vehicle Time (min)",
        "skim_transit_bus_ivtt": "Bus In-Vehicle Time (min)",
        "skim_transit_commuter_rail_ivtt": "Commuter Rail In-Vehicle Time (min)",
        "skim_transit_light_rail_ivtt": "Light Rail In-Vehicle Time (min)",
        "skim_transit_o_maz_stop_walk_bus": "Origin Walk Distance to Local Bus Stop (mi)",
        "skim_transit_d_maz_stop_walk_bus": "Destination Walk Distance from Local Bus Stop (mi)",
        "skim_transit_o_maz_stop_walk_premium": "Origin Walk Distance to Premium Transit Stop (mi)",
        "skim_transit_d_maz_stop_walk_premium": "Destination Walk Distance from Premium Transit Stop (mi)",
        "skim_auto_time_outbound": "Drive Time (min)",
        "skim_auto_time_inbound": "Drive Time (min)",
        "skim_auto_distance_outbound": "Drive Distance (mi)",
        "skim_auto_distance_inbound": "Drive Distance (mi)",
        "skim_auto_cost_outbound": "Drive Cost ($)",
        "skim_auto_cost_inbound": "Drive Cost ($)",
        "skim_walk_time_outbound": "Total Walk Access/Egress Time (min)",
