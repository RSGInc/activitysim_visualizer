...
from processor.summarize.derived_external import apply_external_derived_summaries
...
def merge_summary_table_map_run(
    ...
    if external_run is None:
        return apply_external_derived_summaries(base_runs)
    if not base_runs:
        return apply_external_derived_summaries([external_run])
    ...
    return apply_external_derived_summaries(merged)
