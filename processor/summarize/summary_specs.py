...
SUMMARY_SPECS: tuple[SummarySpec, ...] = (
    ...
    # DEMO VALIDATION SUMMARIES
    SummarySpec(
        "demo_link_summary",
        "allLinkSummary",
        demo_validation.demo_link_summary,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_count_location_counts",
        "countLocCounts",
        demo_validation.demo_count_location_counts,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_count_location_volumes",
        "countLocVolumes",
        demo_validation.demo_count_location_volumes,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_count_location_scatter",
        "countLocScatter",
        demo_validation.demo_count_location_scatter,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_count_location_fit",
        "countLocFit",
        demo_validation.demo_count_location_fit,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_county_flows",
        "countyFlows",
        demo_validation.demo_county_flows,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_county_flows_joja",
        "countyFlows_JoJa",
        demo_validation.demo_county_flows_joja,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_commercial_vehicle_summary",
        "cvm_summary",
        demo_validation.demo_commercial_vehicle_summary,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_commercial_vehicle_vmt_summary",
        "cvm_vmt_summary",
        demo_validation.demo_commercial_vehicle_vmt_summary,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_external_trip_summary",
        "ext_summary",
        demo_validation.demo_external_trip_summary,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_external_vmt_summary",
        "ext_vmt_summary",
        demo_validation.demo_external_vmt_summary,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_auto_vmt_summary",
        "vmtSummary",
        demo_validation.demo_auto_vmt_summary,
        build_by_default=False,
    ),
    SummarySpec(
        "demo_work_from_home_summary",
        "wfh_summary",
        demo_validation.demo_work_from_home_summary,
        build_by_default=False,
    ),
